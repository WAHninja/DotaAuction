    ...
    <>
      <div className="p-5 bg-slate-700/60 rounded-xl border border-slate-500 shadow-md max-w-3xl mx-auto">
        ...
        <ul className="list-disc pl-5 space-y-2 text-sm text-slate-200">
          <li>Matches require <strong>4 or more players</strong>.</li>
          ...
          <li>
            The match ends when a player wins a game while <strong>on a team by themselves</strong>.
          </li>
        </ul>
      </div>
          ...
          <div className="bg-slate-800 border border-slate-600 rounded-xl max-w-md w-full p-6 text-white shadow-xl relative">
            ...
            <div className="space-y-4 text-sm text-slate-200 leading-relaxed">
              ...
              <ul className="list-decimal pl-5 space-y-2">
                <li>
                  <strong>Base reward:</strong> Each winning player receives <strong>1000 gold</strong>.
                </li>
                <li>
                  <strong>Shared bonus:</strong> Half of the losing team’s remaining gold is split evenly among the winning team.
                </li>
              </ul>
