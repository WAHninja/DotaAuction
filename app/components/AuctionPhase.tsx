...
export default function AuctionPhase({
  ...
  const isWaitingForOffers =
    isLoser && offers.length === 0;
  ...
  return (
    <div className="bg-gray-900 bg-opacity-70 p-6 rounded-3xl shadow-2xl mt-6 border border-gray-800">
      ...
      {isWaitingForOffers && (
        <div className="mb-6 text-center text-gray-400 font-semibold text-lg">
        ...
        <div className="mb-8">
          ...
          <div className="mt-4 flex justify-center">
            <button
              ...
              disabled={submitting}
              className="bg-green-600 hover:bg-green-700 text-white font-bold px-6 py-2 rounded-lg w-full max-w-xs"
            >
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {offers.map((offer) => {
          ...
          return (
            <div
              key={offer.id}
              className={`relative p-5 rounded-3xl shadow-2xl border
            ...
            >
              {offer.status !== 'pending' && (
                <div className="absolute top-0 right-0 px-3 py-1 text-sm font-bold bg-green-500 text-white rounded-bl-lg">
              ...
              <div className="flex justify-center mb-4">
                {allOffersSubmitted ? (
                  <div className="flex items-center gap-2 text-3xl font-extrabold text-amber-400 animate-gold-glow">
                    {offer.offer_amount}
                    <Image src="/Gold_symbol.webp" alt="Gold" width={28} height={28} />
                  </div>
                ) : (
              ...
              <div className="mb-3 text-sm text-gray-300">
                ...
                <span className="font-bold">{to?.username}</span>
              </div>
